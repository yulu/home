...
public class GLLayer implements GLSurfaceView.Renderer {
	 ...
	 */
	//Model matrix: move the models from object space to world space
	private float[] mModelMatrix = new float[16];
	//View matrix: transforms world space to eye space
	private float[] mViewMatrix = new float[16];
	//Projection matrix: project the scene onto a 2D viewport
	private float[] mProjectionMatrix = new float[16];
	
	//MVP matrix: combined matrix
	private float[] mMVPMatrix = new float[16];
	
	
	/**
	 * Model data in float buffer
	 */
	...
	/**
	 * Handlers to pass the information to shader
	 */
	//transformation matrix handler
	private int mMVPMatrixHandle;
	//modelview matrix handler
	private int mMVMatrixHandle;
	//light position handler
	private int mLightPosHandle;
	//Texture handler
	private int mTextureUniformHandle;
	//model position handler
	private int mPositionHandle;
	//model normal handler
	private int mNormalHandle;
	//texture coordinate handler
	...
	//size of texture coordinate data in element
	private final int mTextureCoordinateDataSize = 2;
	
	/**
	 * Variables for light
	 */
	//model matrix for light position
	...
	//temporay place to save min and mag filter
	...
	{
		//set the background clear color to back
		...
		//where our head would be pointing were we holding the camera
		...
		/**
		 * set up shader program handlers
		 */
		//model shaders
	...
	public void onSurfaceChanged(GL10 glUnused, int width, int height)
	{
		...
		//create a new perspective projection matrix. The height will satege the same
